# 方案三 DataB：**256×256** + 验证 **P(fg)>0.5**（与 dataa 版同策略，仅数据根）。
# 在 segmentation/ 下: python tools/train.py local_configs/segman_binary/segman_t_datab_256_scheme3.py
_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/datasets/datab_binary_256.py',
]
