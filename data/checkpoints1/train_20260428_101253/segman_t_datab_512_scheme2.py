...
evaluation = dict(
    ...
    save_best='val/IoU',
    greater_keys=[
        'mIoU', 'aAcc', 'mFscore', 'IoU.foreground', 'val/IoU', 'val/mIoU',
        'val/F1'
    ],
    pre_eval=True)
...
segman_run_ts = 'train_20260428_101253'
work_dir = '/root/autodl-tmp/my_MambaVision-main/my_SegMAN-main-main/my_SegMAN-main-main/data/checkpoints1/train_20260428_101253'
gpu_ids = [0]
auto_resume = False
